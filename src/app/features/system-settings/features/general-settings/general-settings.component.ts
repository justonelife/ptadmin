...
import { BackendServicesCardViewComponent } from '@features/system-settings/ui/backend-services-card/backend-services-card.component';
import { VersionCardViewComponent } from '@features/system-settings/ui/version-card/version-card.component';

@Component({
  imports: [VersionCardViewComponent, BackendServicesCardViewComponent],
